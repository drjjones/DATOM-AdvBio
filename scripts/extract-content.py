...
UNITS = [
 dict(number=1, slug='water', folder='unit-01-water', title='Water and the chemistry of life', accent='#4FA3E0', accentName='water blue',
 ...
 dict(number=2, slug='cells-and-membranes', folder='unit-02-cells-and-membranes', title='Cells and membranes', accent='#E0A13F', accentName='lipid gold',
      reading={'B2.1':[('4.1 to 4.8','58 to 81')], 'B2.2':[('5.1','83 to 88')], 'B2.3':[('5.2','88 to 91')],
               'B2.4':[('5.3','91 to 93')], 'B2.5':[('5.3','93 to 95')]}),
 dict(number=3, slug='energy-and-enzymes', folder='unit-03-energy-and-enzymes', title='Energy and enzymes', accent='#E5673A', accentName='ember orange',
      reading={'B3.1':[('6.1','101 to 103')], 'B3.2':[('6.2','103 to 104')], 'B3.3':[('6.2','104 to 105')],
               'B3.4':[('6.3','105 to 109')], 'B3.5':[('6.3 to 6.4','105 to 113')]}),
 dict(number=4, slug='cellular-respiration', folder='unit-04-cellular-respiration', title='Cellular respiration', accent='#D9534F', accentName='oxygen red',
      reading={'B4.1':[('8.1','130 to 132')], 'B4.2':[('8.2','132 to 134')], 'B4.3':[('8.4','136 to 139')],
               'B4.4':[('8.4','139 to 141')], 'B4.5':[('8.3','134 to 136')]}),
 dict(number=5, slug='photosynthesis', folder='unit-05-photosynthesis', title='Photosynthesis', accent='#4CAF50', accentName='chlorophyll green',
      reading={'B5.1':[('7.1 to 7.2','115 to 119')], 'B5.2':[('7.3','119 to 120')], 'B5.3':[('7.3','120 to 123')],
               'B5.4':[('7.4','123 to 125')], 'B5.5':[('7.5','125 to 128')]}),
 dict(number=6, slug='molecular-genetics', folder='unit-06-molecular-genetics', title='Molecular genetics', accent='#8E6FE0', accentName='nucleotide violet',
      reading={'B6.1':[('12.1','208 to 211')], 'B6.2':[('12.2','211 to 216')], 'B6.3':[('12.3 to 12.4','216 to 220')],
               'B6.4':[('12.5','220 to 227')], 'B6.5':[('13.3','238 to 243')]}),
 dict(number=7, slug='cell-division-and-genetics', folder='unit-07-cell-division-and-genetics', title='Cell division and genetics', accent='#D05BA6', accentName='chromosome stain',
 ...
 dict(number=8, slug='evolution', folder='unit-08-evolution', title='Evolution', accent='#3BAFA0', accentName='deep-time teal',
 ...
 dict(number=9, slug='ecology', folder='unit-09-ecology', title='Ecology', accent='#8DB33A', accentName='canopy moss',
 ...
 dict(number=10, slug='anatomy-and-physiology', folder='unit-10-anatomy-physiology', title='Anatomy and physiology', accent='#E06C8A', accentName='tissue rose',
